const Services = () => {
    return (
        ...
        <div className="w-full text-start overflow-hidden">
            <h2 className="text-[33px] mb-5 lg:mb-10 text-start ml-5 lg:text-start lg:ml-18 font-bold">Yallamotor Services</h2>
        </div>
        ...
        <div className="flex flex-wrap justify-start  gap-4 overflow-hidden px-5 lg:px-20">
            <div className=" w-full sm:w-[442px] p-2 flex items-start gap-4 h-full bg-white border border-gray-300 rounded-lg shadow-md text-center">
                ...
                <div className="w-full h-full flex-col space-y-2 text-left ">
                    ...
                    <p className="text-[14px] max-w-[250px] text-[#222]">Sell your car 100% absolutely free on YallaMotor.</p>
                    <a href="#" className="text-[#124d99] font-bold text-sm">Explore More →</a>
                </div>
            </div>
            <div className="w-full sm:w-[442px] p-2 flex items-start gap-4 h-full bg-white border border-gray-300 rounded-lg shadow-md text-center">
